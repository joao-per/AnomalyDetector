// WebGL "ferrofluid" backdrop (ogl full-screen shader) — used on the login
// screen. Ported to TypeScript from the provided reference implementation.
...
export function Ferrofluid({
  ...
  // NOTE: the parent must pass a stable `colors` array (module const / memo) —
  // a fresh literal per render would tear down and rebuild the WebGL context.
