...
const de = {
  ...
  "common.orderNo": "Bestellnr.",
  "common.orderType": "Bestellart",
  ...
  "table.selectAll": "Alle sichtbaren Anomalien auswählen",
  "table.selectRow": "Anomalie {id} auswählen",

  // ── Delete (permanent) ───────────────────────────────────────────
  "delete.selected": "{n} ausgewählt",
  "delete.button": "Löschen",
  "delete.title": "Endgültig löschen?",
  "delete.message":
    "{n} Anomalie(n) werden dauerhaft aus Dataverse gelöscht. Diese Aktion kann nicht rückgängig gemacht werden.",
  "delete.confirm": "Endgültig löschen",
  "delete.cancel": "Abbrechen",
  "delete.working": "Wird gelöscht…",
  "delete.failed": "{n} von {total} Löschungen fehlgeschlagen.",
  ...
  "detail.commentRequired": "(für „Abtrainieren“ erforderlich)",
  "detail.commentPlaceholder": "Begründung / Notiz…",
  "detail.actions": "Aktionen",
  "detail.actionInProgress": "Bearbeitung",
  "detail.actionUntrain": "Abtrainieren",
  "detail.actionCancel": "Erledigt",
...
const en: Record<TranslationKey, string> = {
  ...
  "table.explain": "Erklär mal",
  "table.selectAll": "Select all visible anomalies",
  "table.selectRow": "Select anomaly {id}",

  // ── Delete (permanent) ───────────────────────────────────────────
  "delete.selected": "{n} selected",
  "delete.button": "Delete",
  "delete.title": "Delete permanently?",
  "delete.message":
    "{n} anomaly record(s) will be permanently deleted from Dataverse. This cannot be undone.",
  "delete.confirm": "Delete permanently",
  "delete.cancel": "Cancel",
  "delete.working": "Deleting…",
  "delete.failed": "{n} of {total} deletions failed.",
  ...
  "detail.commentRequired": "(required for “Untrain”)",
  "detail.commentPlaceholder": "Reason / note…",
  "detail.actions": "Actions",
  "detail.actionInProgress": "In progress",
  "detail.actionUntrain": "Untrain",
  "detail.actionCancel": "Done",
